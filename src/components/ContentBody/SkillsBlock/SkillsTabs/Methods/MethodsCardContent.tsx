...
const ResearchTab: React.FC<ITabProps> = ({ lang }) => (
	<TabOuterContainer>
		<TabContainer>
			<TabImage src='/research_photo.png' alt='research photo' />
			<TabSmallImage src='/research_icon.png' alt='research icon' />
...
const AnalysisTab: React.FC<ITabProps> = ({ lang }) => (
	<TabOuterContainer>
		<TabContainer>
			<TabImage src='/analysis_photo.png' alt='analysis photo' />
			<TabSmallImage src='/analysis_icon.png' alt='analysis icon' />
...
const FormationTab: React.FC<ITabProps> = ({ lang }) => (
	<TabOuterContainer>
		<TabContainer>
			<TabImage src='/formation_photo.png' alt='formation photo' />
			<TabSmallImage src='/formation_icon.png' alt='formation icon' />
...
const TestingTab: React.FC<ITabProps> = ({ lang }) => (
	<TabOuterContainer>
		<TabContainer>
			<TabImage src='/testing_photo.png' alt='testing photo' />
			<TabSmallImage src='/testing_icon.png' alt='testing icon' />
